...
(* 2 DecListVCheck: DeclarationList: DeclarationList -> bool *)
...
(* 5 AbsTypingTableNoDeclaration: variable -> NoDeclaration *)
val AbsTypingTableNoDeclaration = (fn (x:Variable) => NoDeclaration)    

(* 6 NewAbsTypingTable: AbsTypingTable (old) -> Declaration -> AbsTypingTable (new) *)             
...
myAbsTypingTable1 var_cur;
myAbsTypingTable1 var_prev1;
myAbsTypingTable1 var_prev2;
myAbsTypingTable1 var_i;
...
myAbsTypingTable2 var_cur;
myAbsTypingTable2 var_prev1;
myAbsTypingTable2 var_prev2;
myAbsTypingTable2 var_i;
...
val ItestGood_3 = InstructionVCheck myAbsTypingTable whileLoop
