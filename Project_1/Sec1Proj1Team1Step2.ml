...
fun DecListVCheck ((a,b)::decListTail : DeclarationList) =
...
(*NewAbsTypingTable: AbsTypingTable --> Declaration --> AbsTypingTable*)
          (* old    new   *)
 fun NewAbsTypingTable (oldatt:AbsTypingTable) (a:Variable, TypeNameBool)
      =(fn (b:variable)=> if b=a then DeclaredBool
                                    else DeclaredInt) |
      NewAbsTypingTable (oldatt:AbsTypingTable) (a:Variable, TypeNameInt)
